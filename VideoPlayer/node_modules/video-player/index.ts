...
class VideoPlayer {
  ...
  private speedList!: HTMLUListElement;
  private timeRange!: HTMLInputElement;
  private volumeRange!: HTMLInputElement;
  private videoTimer!: HTMLDivElement;
  private videos: string[];
  private controlsColor: string;
  ...
  private initControls(containerId: string) {
  ...
  private updateRangeBackground(...range: HTMLInputElement[]) {
    range.forEach((r) => {
  ...
  private initVideoTimer() {
    setInterval(() => {
      ...
      this.videoTimer.textContent = `${this.formatTime(
        currentTime
  ...
  private addEventListeners() {
    ...
    this.muteBtn.addEventListener('mouseover', () =>
      this.volumeRange.classList.add('show')
    );
    this.volumeRange.addEventListener('mouseleave', () =>
      this.volumeRange.classList.remove('show')
    );
  ...
  private changeVideoSpeed(e: Event) {
